  ...
  <div class="ko_left">
    <div class="weatch_top">
      <div class="weatch_right">
        ...
        <div class="w4">Washington,D.C.</div>
      </div>
      <div class="weatch_left">
        <div class="w">
          <div class="w1">MON</div>
          <div class="w2">
            <canvas id="clear-day" width="60" height="60"></canvas>
          </div>
          <div class="w3">86&deg;</div>
        </div>
        <div class="w">
        ...
        <div class="w">
          ...
          <div class="w3">82&deg;</div>
        </div>
        <div class="n" >
          <div class="w1">THU</div>
          <div class="w2">
            <canvas id="sleet"  width="60" height="60"></canvas>
          </div>
          <div class="w3">64&deg;</div>
        </div>
      </div>
    </div>
  </div>
