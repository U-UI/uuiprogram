<template>
  <div class="ko_left">
    <div class="weatch_top">
      <div style="text-align: center;line-height: 30px">动画天气小图标</div>
      <div class="weatch_right" >
          <div class="w1">雨</div>
              <div class="w6">
                  <canvas id="rain" width="30" height="30"></canvas>
              </div>
              <div class="w5">72&deg;</div>
      </div>
      <div class="weatch_right">
          <div class="w1">晴</div>
          <div class="w6">
        ...
        <div class="weatch_right">
          ...
          <div class="w5">32&deg;</div>
        </div>
        <div class="weatch_right">
          <div class="w1">多云日</div>
          <div class="w6">
            <canvas id="partly-cloudy-day"  width="30" height="30"></canvas>
          </div>
          <div class="w5">23&deg;</div>
        </div>
        <div class="weatch_right" >
           <div class="w1">雹</div>
           <div class="w6">
           ...
           <div class="w5">10&deg;</div>
        </div>
        <div class="weatch_right" >
            <div class="w1">雾</div>
            <div class="w6">
                <canvas id="fog"  width="30" height="30"></canvas>
            </div>
            <div class="w5">23&deg;</div>
         </div>
        <div class="weatch_right" >
